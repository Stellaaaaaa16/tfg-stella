...
<!-- menu de administracion al recibir por get la respuesta vemos si el valor de page existe con la pagina creada  -->
    ...
    <!-- Scripts externos necesarios para el calendario y el funcionamiento de la página -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.10.2/fullcalendar.min.js"></script>
    <script>
        // configutacion de lcalendatio
 ...
 // Confirmación para eliminar una cita
